...
[Mastering Metrics, Chapter 1](https://assets.press.princeton.edu/chapters/s10363.pdf) 

<br>

## Lecture 

[Slides from Lecture 6](https://pjakiela.github.io/ECON370/ECON370-L6-RCTs-2025-handout.pdf)  

<br>

## Optional Lab

This lab makes use of the data set [E1-CohenEtAl-data.dta](https://pjakiela.github.io/ECON523/exercises/E1-CohenEtAl-data.dta), 
...
The lab template is available [here](ECON370-lab5-template.R). It is an R script, but it can also be opened in Python.  
